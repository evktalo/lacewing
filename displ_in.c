...
/* BITMAP *outp = create_bitmap((17 * 22) + 1, (17 * 22) + 1);
 ...
 for (i = 0; i < NO_SHIP_TYPES; i ++)
 {
  for (j = 0; j < 18; j ++)
  {
   _allegro__allegro_vline(outp, 0, i * 22, 18 * 22 + 1, COLOUR_PURPLE8);
 ...
 switch(at)
 {
  case 1:
   for (i = 0; i < 17; i ++)
   {
    ...
    angle = i / (16 / (M_PI / 2)) - M_PI / 2;
    if (i == 16)
     angle = 0;
    x1 = 100 + cos(angle) * 7;
    y1 = 100 + sin(angle) * 7;
    x2 = 100 + cos(angle + M_PI + M_PI / 3) * 6;
    y2 = 100 + sin(angle + M_PI + M_PI / 3) * 6;
    x3 = 100 + cos(angle + M_PI - M_PI / 3) * 6;
    y3 = 100 + sin(angle + M_PI - M_PI / 3) * 6;
    triangle(ship_bitmaps [at] [i], x1, y1, x2, y2, x3, y3, COLOUR_GREY4);
    x1 = 100 + cos(angle) * 6;
    y1 = 100 + sin(angle) * 6;
    x2 = 100 + cos(angle + M_PI + M_PI / 3) * 5;
    y2 = 100 + sin(angle + M_PI + M_PI / 3) * 5;
    x3 = 100 + cos(angle + M_PI - M_PI / 3) * 5;
    y3 = 100 + sin(angle + M_PI - M_PI / 3) * 5;
...
//  line(ship_bitmaps [at] [i], x1, y1, x3, y3, COLOUR_GREY4);
  ...
  case 2:
   for (i = 0; i < 17; i ++)
   {
    ...
    x2 = 100 + cos(angle + M_PI - M_PI / 3) * (6 - (angle == 16));
    y2 = 100 + sin(angle + M_PI - M_PI / 3) * (6 - (angle == 16));
    circlefill(ship_bitmaps [at] [i], x2, y2, 2, COLOUR_GREY5);
    x = 10;
    y = 10;
...
//     a2 = a3;
  ...
  case 3:
   for (i = 0; i < 17; i ++)
   {
    ...
    x2 = 100 + cos(angle + M_PI + M_PI / 4) * 5;
    y2 = 100 + sin(angle + M_PI + M_PI / 4) * 5;
    circlefill(ship_bitmaps [at] [i], x2, y2, 2, COLOUR_GREY4);
    circlefill(ship_bitmaps [at] [i], x2, y2, 1, COLOUR_GREY5);
    x2 = 100 + cos(angle + M_PI + M_PI / 4) * 2;
    y2 = 100 + sin(angle + M_PI + M_PI / 4) * 2;
    circlefill(ship_bitmaps [at] [i], x2, y2, 1, COLOUR_GREY5);
    x2 = 100 + cos(angle + M_PI - M_PI / 4) * 5;
    y2 = 100 + sin(angle + M_PI - M_PI / 4) * 5;
    circlefill(ship_bitmaps [at] [i], x2, y2, 2, COLOUR_GREY4);
    ...
    y2 = 100 + sin(angle + M_PI - M_PI / 4) * 2;
    circlefill(ship_bitmaps [at] [i], x2, y2, 2, COLOUR_GREY5);
    x2 = 100 + cos(angle + M_PI / 4) * 5;
    y2 = 100 + sin(angle + M_PI / 4) * 5;
    circlefill(ship_bitmaps [at] [i], x2, y2, 2, COLOUR_GREY4);
    circlefill(ship_bitmaps [at] [i], x2, y2, 1, COLOUR_GREY5);
    x2 = 100 + cos(angle + M_PI / 4) * 2;
    y2 = 100 + sin(angle + M_PI / 4) * 2;
    circlefill(ship_bitmaps [at] [i], x2, y2, 2, COLOUR_GREY5);
    x2 = 100 + cos(angle - M_PI / 4) * 5;
    y2 = 100 + sin(angle - M_PI / 4) * 5;
    circlefill(ship_bitmaps [at] [i], x2, y2, 2, COLOUR_GREY4);
...
/*    circlefill(tbmp, 10, 10, 6, COLOUR_GREY5);
  ...
  case 6:
   for (i = 0; i < 17; i ++)
   {
    ...
    if (i == 16)
     angle = 0;
    x1 = 100 + cos(angle + M_PI) * 5;
    y1 = 100 + sin(angle + M_PI) * 5;
    x2 = 100 + cos(angle + M_PI / 2) * 9;
    y2 = 100 + sin(angle + M_PI / 2) * 9;
    x3 = 100 + cos(angle - M_PI / 2) * 9;
    y3 = 100 + sin(angle - M_PI / 2) * 9;
    triangle(ship_bitmaps [at] [i], x1, y1, x2, y2, x3, y3, COLOUR_GREY4);
    x1 = 100 + cos(angle) * 7;
    y1 = 100 + sin(angle) * 7;
    x2 = 100 + cos(angle + M_PI + M_PI / 3) * 4;
    y2 = 100 + sin(angle + M_PI + M_PI / 3) * 4;
    x3 = 100 + cos(angle + M_PI - M_PI / 3) * 4;
    y3 = 100 + sin(angle + M_PI - M_PI / 3) * 4;
    triangle(ship_bitmaps [at] [i], x1, y1, x2, y2, x3, y3, COLOUR_GREY4);
    x1 = 100 + cos(angle) * 6;
    y1 = 100 + sin(angle) * 6;
    x2 = 100 + cos(angle + M_PI + M_PI / 3) * 3;
    y2 = 100 + sin(angle + M_PI + M_PI / 3) * 3;
    x3 = 100 + cos(angle + M_PI - M_PI / 3) * 3;
    y3 = 100 + sin(angle + M_PI - M_PI / 3) * 3;
    triangle(ship_bitmaps [at] [i], x1, y1, x2, y2, x3, y3, COLOUR_GREY5);
    x1 = 100 + cos(angle + M_PI) * 4;
    y1 = 100 + sin(angle + M_PI) * 4;
    x2 = 100 + cos(angle + M_PI / 2) * 8;
    y2 = 100 + sin(angle + M_PI / 2) * 8;
    x3 = 100 + cos(angle - M_PI / 2) * 8;
    y3 = 100 + sin(angle - M_PI / 2) * 8;
    triangle(ship_bitmaps [at] [i], x1, y1, x2, y2, x3, y3, COLOUR_GREY5);
...
//  line(ship_bitmaps [at] [i], x1, y1, x3, y3, COLOUR_GREY4);
  ...
  case 7:
   for (i = 0; i < 17; i ++)
   {
    ...
    x1 = x + cos(angle + M_PI / 3) * 6;
    y1 = y + sin(angle + M_PI / 3) * 6;
    ...
    line(ship_bitmaps [at] [i], x, y, x1, y1, COLOUR_GREY4);
    putpixel(ship_bitmaps [at] [i], x1, y1, COLOUR_GREY6);
    x1 = x + cos(angle + M_PI + M_PI / 2) * 6;
    y1 = y + sin(angle + M_PI + M_PI / 2) * 6;
    line(ship_bitmaps [at] [i], x, y, x1, y1, COLOUR_GREY4);
    putpixel(ship_bitmaps [at] [i], x1, y1, COLOUR_GREY6);
    x1 = x + cos(angle + M_PI - M_PI / 2) * 7;
    y1 = y + sin(angle + M_PI - M_PI / 2) * 7;
    line(ship_bitmaps [at] [i], x, y, x1, y1, COLOUR_GREY4);
    putpixel(ship_bitmaps [at] [i], x1, y1, COLOUR_GREY6);
    x1 = 100 + cos(angle + M_PI + M_PI / 3) * 6;
    y1 = 100 + sin(angle + M_PI + M_PI / 3) * 6;
    line(ship_bitmaps [at] [i], x, y, x1, y1, COLOUR_GREY4);
    putpixel(ship_bitmaps [at] [i], x1, y1, COLOUR_GREY6);
    x1 = 100 + cos(angle + M_PI - M_PI / 3) * 6;
    y1 = 100 + sin(angle + M_PI - M_PI / 3) * 6;
    line(ship_bitmaps [at] [i], x, y, x1, y1, COLOUR_GREY4);
    putpixel(ship_bitmaps [at] [i], x1, y1, COLOUR_GREY6);
    x1 = 100 + cos(angle + M_PI + M_PI / 6) * 7;
    y1 = 100 + sin(angle + M_PI + M_PI / 6) * 7;
    line(ship_bitmaps [at] [i], x, y, x1, y1, COLOUR_GREY4);
    putpixel(ship_bitmaps [at] [i], x1, y1, COLOUR_GREY6);
    x1 = 100 + cos(angle + M_PI - M_PI / 5) * 7;
    y1 = 100 + sin(angle + M_PI - M_PI / 5) * 7;
    line(ship_bitmaps [at] [i], x, y, x1, y1, COLOUR_GREY4);
    putpixel(ship_bitmaps [at] [i], x1, y1, COLOUR_GREY6);
    x = 100 + cos(angle) * 3;
    y = 100 + sin(angle) * 3;
  ...
  case 8:
   for (i = 0; i < 17; i ++)
   {
    ...
    x1 = 100 + cos(angle) * 7;
    y1 = 100 + sin(angle) * 7;
    x2 = 100 + cos(angle + M_PI / 2) * 4;
    y2 = 100 + sin(angle + M_PI / 2) * 4;
    x3 = 100 + cos(angle - M_PI / 2) * 4;
    y3 = 100 + sin(angle - M_PI / 2) * 4;
    triangle(ship_bitmaps [at] [i], x1, y1, x2, y2, x3, y3, COLOUR_GREY4);
    x1 = 100 + cos(angle) * 6;
    y1 = 100 + sin(angle) * 6;
    x2 = 100 + cos(angle + M_PI / 2) * 3;
    y2 = 100 + sin(angle + M_PI / 2) * 3;
    x3 = 100 + cos(angle - M_PI / 2) * 3;
    y3 = 100 + sin(angle - M_PI / 2) * 3;
    triangle(ship_bitmaps [at] [i], x1, y1, x2, y2, x3, y3, COLOUR_GREY5);
    x1 = 100 + cos(angle) * 6;
    y1 = 100 + sin(angle) * 6;
    x2 = 100 + cos(angle + M_PI - M_PI / 2) * 8;
    y2 = 100 + sin(angle + M_PI - M_PI / 2) * 8;
    x3 = 100 + cos(angle + M_PI - M_PI / 4) * 8;
    y3 = 100 + sin(angle + M_PI - M_PI / 4) * 8;
    triangle(ship_bitmaps [at] [i], x1, y1, x2, y2, x3, y3, COLOUR_GREY4);
    x1 = 100 + cos(angle) * 6;
    y1 = 100 + sin(angle) * 6;
    x2 = 100 + cos(angle + M_PI + M_PI / 2) * 8;
    ...
    x1 = 100 + cos(angle) * 5;
    y1 = 100 + sin(angle) * 5;
    x2 = 100 + cos(angle + M_PI - M_PI / 2) * 7;
    y2 = 100 + sin(angle + M_PI - M_PI / 2) * 7;
    x3 = 100 + cos(angle + M_PI - M_PI / 4) * 7;
    y3 = 100 + sin(angle + M_PI - M_PI / 4) * 7;
    triangle(ship_bitmaps [at] [i], x1, y1, x2, y2, x3, y3, COLOUR_GREY5);
    x1 = 100 + cos(angle) * 5;
    y1 = 100 + sin(angle) * 5;
    x2 = 100 + cos(angle + M_PI + M_PI / 2) * 7;
  ...
  case 10:
   for (i = 0; i < 17; i ++)
   {
    ...
    x1 = 100 + cos(angle) * 6;
    y1 = 100 + sin(angle) * 6;
    x2 = 100 + cos(angle + M_PI - M_PI / 4) * 8;
    y2 = 100 + sin(angle + M_PI - M_PI / 4) * 8;
    x3 = 100 + cos(angle + M_PI - M_PI / 8) * 8;
    y3 = 100 + sin(angle + M_PI - M_PI / 8) * 8;
    triangle(ship_bitmaps [at] [i], x1, y1, x2, y2, x3, y3, COLOUR_GREY4);
    x1 = 100 + cos(angle) * 6;
    y1 = 100 + sin(angle) * 6;
    x2 = 100 + cos(angle + M_PI + M_PI / 4) * 8;
    ...
    x1 = 100 + cos(angle) * 5;
    y1 = 100 + sin(angle) * 5;
    x2 = 100 + cos(angle + M_PI - M_PI / 4) * 7;
    y2 = 100 + sin(angle + M_PI - M_PI / 4) * 7;
    x3 = 100 + cos(angle + M_PI - M_PI / 8) * 7;
    y3 = 100 + sin(angle + M_PI - M_PI / 8) * 7;
    triangle(ship_bitmaps [at] [i], x1, y1, x2, y2, x3, y3, COLOUR_GREY5);
    x1 = 100 + cos(angle) * 5;
    y1 = 100 + sin(angle) * 5;
    x2 = 100 + cos(angle + M_PI + M_PI / 4) * 7;
...
//  case 11:
   for (i = 0; i < 17; i ++)
   {
    ...
    if (i == 16)
     angle = 0;
/*
    points [0] = 100 + cos(angle + M_PI / 2) * 30;
    points [1] = 100 + sin(angle + M_PI / 2) * 30;
    points [2] = 100 + cos(angle + M_PI / 10) * 80;
    points [3] = 100 + sin(angle + M_PI / 10) * 80;
    points [4] = 100 + cos(angle + M_PI / 7) * 90;
    points [5] = 100 + sin(angle + M_PI / 7) * 90;
    points [6] = 100 + cos(angle + M_PI - M_PI / 3) * 50;
    points [7] = 100 + sin(angle + M_PI - M_PI / 3) * 50;
    points [8] = 100 + cos(angle + M_PI + M_PI / 3) * 50;
    points [9] = 100 + sin(angle + M_PI + M_PI / 3) * 50;
    points [10] = 100 + cos(angle - M_PI / 7) * 90;
    points [11] = 100 + sin(angle - M_PI / 7) * 90;
    points [12] = 100 + cos(angle - M_PI / 10) * 80;
    points [13] = 100 + sin(angle - M_PI / 10) * 80;
    points [14] = 100 + cos(angle - M_PI / 2) * 30;
    points [15] = 100 + sin(angle - M_PI / 2) * 30;
    polygon(ship_bitmaps [at] [i], 8, points, COLOUR_GREY4);
    
    x1 = 100 + cos(angle + M_PI) * 40;
    y1 = 100 + sin(angle + M_PI) * 40;
    x2 = 100 + cos(angle + M_PI / 2) * 70;
    y2 = 100 + sin(angle + M_PI / 2) * 70;
    x3 = 100 + cos(angle - M_PI / 2) * 70;
    y3 = 100 + sin(angle - M_PI / 2) * 70;
    triangle(ship_bitmaps [at] [i], x1, y1, x2, y2, x3, y3, COLOUR_GREY4);
    x1 = 100 + cos(angle + M_PI) * 30;
    y1 = 100 + sin(angle + M_PI) * 30;
    x2 = 100 + cos(angle + M_PI / 2) * 60;
    y2 = 100 + sin(angle + M_PI / 2) * 60;
    x3 = 100 + cos(angle - M_PI / 2) * 60;
    y3 = 100 + sin(angle - M_PI / 2) * 60;
    triangle(ship_bitmaps [at] [i], x1, y1, x2, y2, x3, y3, COLOUR_GREY5);
    
    points [0] = 100 + cos(angle + M_PI / 2) * 20;
    points [1] = 100 + sin(angle + M_PI / 2) * 20;
    points [2] = 100 + cos(angle + M_PI / 8) * 70;
    points [3] = 100 + sin(angle + M_PI / 8) * 70;
    points [4] = 100 + cos(angle + M_PI / 5) * 80;
    points [5] = 100 + sin(angle + M_PI / 5) * 80;
    points [6] = 100 + cos(angle + M_PI - M_PI / 3) * 40;
    points [7] = 100 + sin(angle + M_PI - M_PI / 3) * 40;
    points [8] = 100 + cos(angle + M_PI + M_PI / 3) * 40;
    points [9] = 100 + sin(angle + M_PI + M_PI / 3) * 40;
    points [10] = 100 + cos(angle - M_PI / 5) * 80;
    points [11] = 100 + sin(angle - M_PI / 5) * 80;
    points [12] = 100 + cos(angle - M_PI / 8) * 70;
    points [13] = 100 + sin(angle - M_PI / 8) * 70;
    points [14] = 100 + cos(angle - M_PI / 2) * 20;
    points [15] = 100 + sin(angle - M_PI / 2) * 20;
...
//  case 11:
   for (i = 0; i < 17; i ++)
   {
    ...
    points [2] = 100 + cos(angle + M_PI / 2) * 9;
    points [3] = 100 + sin(angle + M_PI / 2) * 9;
    points [4] = 100 + cos(angle + M_PI) * 2;
    points [5] = 100 + sin(angle + M_PI) * 2;
    points [6] = 100 + cos(angle - M_PI / 2) * 7;
    points [7] = 100 + sin(angle - M_PI / 2) * 7;
...
//    circle(ship_bitmaps [at] [i], x, y, 7, COLOUR_GREY4);
    ...
    points [2] = 100 + cos(angle + M_PI / 2) * 8;
    points [3] = 100 + sin(angle + M_PI / 2) * 8;
    points [4] = 100 + cos(angle + M_PI) * 1;
    points [5] = 100 + sin(angle + M_PI) * 1;
    points [6] = 100 + cos(angle - M_PI / 2) * 6;
    points [7] = 100 + sin(angle - M_PI / 2) * 6;
...
//    circlefill(ship_bitmaps [at] [i], 10, 10, 1, COLOUR_GREY6);
  ...
  case 11:
   for (i = 0; i < 17; i ++)
   {
    ...
    x1 = 100 + cos(angle) * 70;
    y1 = 100 + sin(angle) * 70;
    x2 = 100 + cos(angle + M_PI / 2) * 40;
    y2 = 100 + sin(angle + M_PI / 2) * 40;
    x3 = 100 + cos(angle - M_PI / 2) * 40;
    y3 = 100 + sin(angle - M_PI / 2) * 40;
    triangle(tbmp, x1, y1, x2, y2, x3, y3, COLOUR_GREY4);
    x1 = 100 + cos(angle) * 60;
    y1 = 100 + sin(angle) * 60;
    x2 = 100 + cos(angle + M_PI / 2) * 30;
    y2 = 100 + sin(angle + M_PI / 2) * 30;
    x3 = 100 + cos(angle - M_PI / 2) * 30;
    y3 = 100 + sin(angle - M_PI / 2) * 30;
    triangle(tbmp, x1, y1, x2, y2, x3, y3, COLOUR_GREY5);
    x1 = 100 + cos(angle) * 60;
    y1 = 100 + sin(angle) * 60;
    x2 = 100 + cos(angle + M_PI - M_PI / 4) * 80;
    y2 = 100 + sin(angle + M_PI - M_PI / 4) * 80;
    x3 = 100 + cos(angle + M_PI - M_PI / 8) * 80;
    y3 = 100 + sin(angle + M_PI - M_PI / 8) * 80;
    triangle(tbmp, x1, y1, x2, y2, x3, y3, COLOUR_GREY4);
    x1 = 100 + cos(angle) * 60;
    y1 = 100 + sin(angle) * 60;
    x2 = 100 + cos(angle + M_PI + M_PI / 4) * 80;
    ...
    x1 = 100 + cos(angle) * 50;
    y1 = 100 + sin(angle) * 50;
    x2 = 100 + cos(angle + M_PI - M_PI / 4) * 70;
    y2 = 100 + sin(angle + M_PI - M_PI / 4) * 70;
    x3 = 100 + cos(angle + M_PI - M_PI / 8) * 70;
    y3 = 100 + sin(angle + M_PI - M_PI / 8) * 70;
    triangle(tbmp, x1, y1, x2, y2, x3, y3, COLOUR_GREY5);
    x1 = 100 + cos(angle) * 50;
    y1 = 100 + sin(angle) * 50;
    x2 = 100 + cos(angle + M_PI + M_PI / 4) * 70;
 ...
 switch(at)
 {
  case 1:
   for (i = 0; i < 17; i ++)
   {
    ...
    x1 = 100 + cos(angle) * 70;
    y1 = 100 + sin(angle) * 70;
    x2 = 100 + cos(angle + M_PI + M_PI / 3) * 60;
    y2 = 100 + sin(angle + M_PI + M_PI / 3) * 60;
    x3 = 100 + cos(angle + M_PI - M_PI / 3) * 60;
    y3 = 100 + sin(angle + M_PI - M_PI / 3) * 60;
    triangle(tbmp, x1, y1, x2, y2, x3, y3, COLOUR_GREY4);
    x1 = 100 + cos(angle) * 60;
    y1 = 100 + sin(angle) * 60;
    x2 = 100 + cos(angle + M_PI + M_PI / 3) * 50;
    y2 = 100 + sin(angle + M_PI + M_PI / 3) * 50;
    x3 = 100 + cos(angle + M_PI - M_PI / 3) * 50;
    y3 = 100 + sin(angle + M_PI - M_PI / 3) * 50;
    triangle(tbmp, x1, y1, x2, y2, x3, y3, COLOUR_GREY5);
    x1 = 100 + cos(angle) * 30;
    y1 = 100 + sin(angle) * 30;
    circlefill(tbmp, x1, y1, 10, COLOUR_WHITE);
...
//     a2 = a3;
  ...
  case 3:
   for (i = 0; i < 17; i ++)
   {
    ...
    x2 = 100 + cos(angle + M_PI + M_PI / 4) * 50;
    y2 = 100 + sin(angle + M_PI + M_PI / 4) * 50;
    circlefill(tbmp, x2, y2, 20, COLOUR_GREY4);
    circlefill(tbmp, x2, y2, 10, COLOUR_GREY5);
    x2 = 100 + cos(angle + M_PI + M_PI / 4) * 20;
    y2 = 100 + sin(angle + M_PI + M_PI / 4) * 20;
    circlefill(tbmp, x2, y2, 10, COLOUR_GREY5);
    x2 = 100 + cos(angle + M_PI - M_PI / 4) * 50;
    y2 = 100 + sin(angle + M_PI - M_PI / 4) * 50;
    circlefill(tbmp, x2, y2, 20, COLOUR_GREY4);
    ...
    y2 = 100 + sin(angle + M_PI - M_PI / 4) * 20;
    circlefill(tbmp, x2, y2, 20, COLOUR_GREY5);
    x2 = 100 + cos(angle + M_PI / 4) * 50;
    y2 = 100 + sin(angle + M_PI / 4) * 50;
    circlefill(tbmp, x2, y2, 20, COLOUR_GREY4);
    circlefill(tbmp, x2, y2, 10, COLOUR_GREY5);
    x2 = 100 + cos(angle + M_PI / 4) * 20;
    y2 = 100 + sin(angle + M_PI / 4) * 20;
    circlefill(tbmp, x2, y2, 20, COLOUR_GREY5);
    x2 = 100 + cos(angle - M_PI / 4) * 50;
    y2 = 100 + sin(angle - M_PI / 4) * 50;
    circlefill(tbmp, x2, y2, 20, COLOUR_GREY4);
...
/*    circlefill(tbmp, 10, 10, 6, COLOUR_GREY5);
  ...
  case 6:
   for (i = 0; i < 17; i ++)
   {
    ...
    if (i == 16)
     angle = 0;
    x1 = 100 + cos(angle + M_PI) * 50;
    y1 = 100 + sin(angle + M_PI) * 50;
    x2 = 100 + cos(angle + M_PI / 2) * 90;
    y2 = 100 + sin(angle + M_PI / 2) * 90;
    x3 = 100 + cos(angle - M_PI / 2) * 90;
    y3 = 100 + sin(angle - M_PI / 2) * 90;
    triangle(tbmp, x1, y1, x2, y2, x3, y3, COLOUR_GREY4);
    x1 = 100 + cos(angle) * 70;
    y1 = 100 + sin(angle) * 70;
    x2 = 100 + cos(angle + M_PI + M_PI / 3) * 40;
    y2 = 100 + sin(angle + M_PI + M_PI / 3) * 40;
    x3 = 100 + cos(angle + M_PI - M_PI / 3) * 40;
    y3 = 100 + sin(angle + M_PI - M_PI / 3) * 40;
    triangle(tbmp, x1, y1, x2, y2, x3, y3, COLOUR_GREY4);
    x1 = 100 + cos(angle) * 60;
    y1 = 100 + sin(angle) * 60;
    x2 = 100 + cos(angle + M_PI + M_PI / 3) * 30;
    y2 = 100 + sin(angle + M_PI + M_PI / 3) * 30;
    x3 = 100 + cos(angle + M_PI - M_PI / 3) * 30;
    y3 = 100 + sin(angle + M_PI - M_PI / 3) * 30;
    triangle(tbmp, x1, y1, x2, y2, x3, y3, COLOUR_GREY5);
    x1 = 100 + cos(angle + M_PI) * 40;
    y1 = 100 + sin(angle + M_PI) * 40;
    x2 = 100 + cos(angle + M_PI / 2) * 80;
    y2 = 100 + sin(angle + M_PI / 2) * 80;
    x3 = 100 + cos(angle - M_PI / 2) * 80;
    y3 = 100 + sin(angle - M_PI / 2) * 80;
    triangle(tbmp, x1, y1, x2, y2, x3, y3, COLOUR_GREY5);
...
//  line(ship_bitmaps [at] [i], x1, y1, x3, y3, COLOUR_GREY4);
  ...
  case 7:
   for (i = 0; i < 17; i ++)
   {
    ...
    x1 = x + cos(angle + M_PI / 3) * 60;
    y1 = y + sin(angle + M_PI / 3) * 60;
    line(ship_bitmaps [at] [i], x, y, x1, y1, COLOUR_GREY4);
    putpixel(ship_bitmaps [at] [i], x1, y1, COLOUR_GREY6);
    x1 = x + cos(angle - M_PI / 3) * 60;
    y1 = y + sin(angle - M_PI / 3) * 60;
    line(ship_bitmaps [at] [i], x, y, x1, y1, COLOUR_GREY4);
    putpixel(ship_bitmaps [at] [i], x1, y1, COLOUR_GREY6);
    x1 = x + cos(angle + M_PI + M_PI / 2) * 60;
    y1 = y + sin(angle + M_PI + M_PI / 2) * 60;
    line(ship_bitmaps [at] [i], x, y, x1, y1, COLOUR_GREY4);
    putpixel(ship_bitmaps [at] [i], x1, y1, COLOUR_GREY6);
    x1 = x + cos(angle + M_PI - M_PI / 2) * 70;
    y1 = y + sin(angle + M_PI - M_PI / 2) * 70;
    line(ship_bitmaps [at] [i], x, y, x1, y1, COLOUR_GREY4);
    putpixel(ship_bitmaps [at] [i], x1, y1, COLOUR_GREY6);
    x1 = 100 + cos(angle + M_PI + M_PI / 3) * 60;
    y1 = 100 + sin(angle + M_PI + M_PI / 3) * 60;
    line(ship_bitmaps [at] [i], x, y, x1, y1, COLOUR_GREY4);
    putpixel(ship_bitmaps [at] [i], x1, y1, COLOUR_GREY6);
    x1 = 100 + cos(angle + M_PI - M_PI / 3) * 60;
    y1 = 100 + sin(angle + M_PI - M_PI / 3) * 60;
    line(ship_bitmaps [at] [i], x, y, x1, y1, COLOUR_GREY4);
    putpixel(ship_bitmaps [at] [i], x1, y1, COLOUR_GREY6);
    x1 = 100 + cos(angle + M_PI + M_PI / 6) * 70;
    y1 = 100 + sin(angle + M_PI + M_PI / 6) * 70;
    line(ship_bitmaps [at] [i], x, y, x1, y1, COLOUR_GREY4);
    putpixel(ship_bitmaps [at] [i], x1, y1, COLOUR_GREY6);
    x1 = 100 + cos(angle + M_PI - M_PI / 5) * 70;
    y1 = 100 + sin(angle + M_PI - M_PI / 5) * 70;
    line(ship_bitmaps [at] [i], x, y, x1, y1, COLOUR_GREY4);
    putpixel(ship_bitmaps [at] [i], x1, y1, COLOUR_GREY6);
    x = 100 + cos(angle) * 30;
    y = 100 + sin(angle) * 30;
  ...
  case 8:
   for (i = 0; i < 17; i ++)
   {
    ...
    x1 = 100 + cos(angle) * 70;
    y1 = 100 + sin(angle) * 70;
    x2 = 100 + cos(angle + M_PI / 2) * 50;
    y2 = 100 + sin(angle + M_PI / 2) * 50;
    x3 = 100 + cos(angle - M_PI / 2) * 50;
    y3 = 100 + sin(angle - M_PI / 2) * 50;
    triangle(tbmp, x1, y1, x2, y2, x3, y3, COLOUR_GREY4);
    x1 = 100 + cos(angle) * 60;
    y1 = 100 + sin(angle) * 60;
    x2 = 100 + cos(angle + M_PI / 2) * 40;
    ...
    x1 = 100 + cos(angle) * 60;
    y1 = 100 + sin(angle) * 60;
    x2 = 100 + cos(angle + M_PI - M_PI / 2) * 80;
    y2 = 100 + sin(angle + M_PI - M_PI / 2) * 80;
    x3 = 100 + cos(angle + M_PI - M_PI / 4) * 80;
    y3 = 100 + sin(angle + M_PI - M_PI / 4) * 80;
    triangle(tbmp, x1, y1, x2, y2, x3, y3, COLOUR_GREY4);
    x1 = 100 + cos(angle) * 60;
    y1 = 100 + sin(angle) * 60;
    x2 = 100 + cos(angle + M_PI + M_PI / 2) * 80;
    ...
    x1 = 100 + cos(angle) * 50;
    y1 = 100 + sin(angle) * 50;
    x2 = 100 + cos(angle + M_PI - M_PI / 2) * 70;
    y2 = 100 + sin(angle + M_PI - M_PI / 2) * 70;
    x3 = 100 + cos(angle + M_PI - M_PI / 4) * 70;
    y3 = 100 + sin(angle + M_PI - M_PI / 4) * 70;
    triangle(tbmp, x1, y1, x2, y2, x3, y3, COLOUR_GREY5);
    x1 = 100 + cos(angle) * 50;
    y1 = 100 + sin(angle) * 50;
    x2 = 100 + cos(angle + M_PI + M_PI / 2) * 70;
...
/*    x1 = 100 + cos(angle) * 70;
  ...
  case 9:
   for (i = 0; i < 17; i ++)
   {
    ...
    x1 = 100 + cos(angle) * 60;
    y1 = 100 + sin(angle) * 60;
    x2 = 100 + cos(angle + M_PI / 2) * 20;
    y2 = 100 + sin(angle + M_PI / 2) * 20;
    x3 = 100 + cos(angle - M_PI / 2) * 20;
    y3 = 100 + sin(angle - M_PI / 2) * 20;
    triangle(tbmp, x1, y1, x2, y2, x3, y3, COLOUR_GREY5);
    x1 = 100 + cos(angle) * 60;
    y1 = 100 + sin(angle) * 60;
    x2 = 100 + cos(angle + M_PI - M_PI / 4) * 80;
...
/*  case 12:
   for (i = 0; i < 17; i ++)
   {
    ...
    points [2] = 100 + cos(angle + M_PI / 2) * 90;
    points [3] = 100 + sin(angle + M_PI / 2) * 90;
    points [4] = 100 + cos(angle + M_PI) * 20;
    points [5] = 100 + sin(angle + M_PI) * 20;
    points [6] = 100 + cos(angle - M_PI / 2) * 70;
    points [7] = 100 + sin(angle - M_PI / 2) * 70;
    polygon(ship_bitmaps [at] [i], 4, points, COLOUR_GREY4);
...
//    circle(tbmp, x, y, 7, COLOUR_GREY4);
    ...
    points [0] = 100 + cos(angle) * 1;
    points [1] = 100 + sin(angle) * 1;
    points [2] = 100 + cos(angle + M_PI / 2) * 80;
    points [3] = 100 + sin(angle + M_PI / 2) * 80;
    points [4] = 100 + cos(angle + M_PI) * 1;
    points [5] = 100 + sin(angle + M_PI) * 1;
    points [6] = 100 + cos(angle - M_PI / 2) * 60;
    points [7] = 100 + sin(angle - M_PI / 2) * 60;
    polygon(ship_bitmaps [at] [i], 4, points, COLOUR_GREY5);
...
//.    tbmp = create_bitmap(210, 210);
  ...
  case 12:
   for (i = 0; i < 17; i ++)
   {
    ...
    y3 = 100 + sin(angle - M_PI / 2) * 40;
    triangle(tbmp, x1, y1, x2, y2, x3, y3, COLOUR_GREY4);
    x1 = 100 + cos(angle + M_PI - M_PI / 3) * 90;
    y1 = 100 + sin(angle + M_PI - M_PI / 3) * 90;
    x2 = 100 + cos(angle + M_PI / 4) * 40;
    y2 = 100 + sin(angle + M_PI / 4) * 40;
    x3 = 100 + cos(angle + M_PI) * 20;
    y3 = 100 + sin(angle + M_PI) * 20;
    triangle(tbmp, x1, y1, x2, y2, x3, y3, COLOUR_GREY4);
    x1 = 100 + cos(angle + M_PI + M_PI / 3) * 90;
    y1 = 100 + sin(angle + M_PI + M_PI / 3) * 90;
    x2 = 100 + cos(angle - M_PI / 4) * 40;
    ...
    y3 = 100 + sin(angle - M_PI / 2) * 30;
    triangle(tbmp, x1, y1, x2, y2, x3, y3, COLOUR_GREY5);
    x1 = 100 + cos(angle + M_PI - M_PI / 3) * 80;
    y1 = 100 + sin(angle + M_PI - M_PI / 3) * 80;
    x2 = 100 + cos(angle + M_PI / 4) * 30;
    y2 = 100 + sin(angle + M_PI / 4) * 30;
    x3 = 100 + cos(angle + M_PI) * 10;
    y3 = 100 + sin(angle + M_PI) * 10;
    triangle(tbmp, x1, y1, x2, y2, x3, y3, COLOUR_GREY5);
    x1 = 100 + cos(angle + M_PI + M_PI / 3) * 80;
    y1 = 100 + sin(angle + M_PI + M_PI / 3) * 80;
    x2 = 100 + cos(angle - M_PI / 4) * 30;
...
/*    x1 = 100 + cos(angle + M_PI / 2) * 80;
    y1 = 100 + sin(angle + M_PI / 2) * 80;
    x2 = 100;// + cos(angle + M_PI / 2) * 20;
    y2 = 100;// + sin(angle + M_PI / 2) * 20;
    x3 = 100 + cos(angle + M_PI / 2 + M_PI / 5) * 80;
    y3 = 100 + sin(angle + M_PI / 2 + M_PI / 5) * 80;
    triangle(tbmp, x1, y1, x2, y2, x3, y3, COLOUR_GREY4);
    x1 = 100 + cos(angle - M_PI / 2) * 80;
    y1 = 100 + sin(angle - M_PI / 2) * 80;
    x2 = 100;// + cos(angle + M_PI / 2) * 20;
    ...
    x1 = 100 + cos(angle) * 70;
    y1 = 100 + sin(angle) * 70;
    x2 = 100 + cos(angle + M_PI / 2) * 35;
    y2 = 100 + sin(angle + M_PI / 2) * 35;
    x3 = 100 + cos(angle - M_PI / 2) * 35;
    y3 = 100 + sin(angle - M_PI / 2) * 35;
    triangle(tbmp, x1, y1, x2, y2, x3, y3, COLOUR_GREY5);
    x1 = 100 + cos(angle + M_PI / 2) * 70;
    y1 = 100 + sin(angle + M_PI / 2) * 70;
    x2 = 100;// + cos(angle + M_PI / 2) * 20;
    y2 = 100;// + sin(angle + M_PI / 2) * 20;
    x3 = 100 + cos(angle + M_PI / 2 + M_PI / 5) * 70;
    y3 = 100 + sin(angle + M_PI / 2 + M_PI / 5) * 70;
    triangle(tbmp, x1, y1, x2, y2, x3, y3, COLOUR_GREY5);
    x1 = 100 + cos(angle - M_PI / 2) * 70;
    y1 = 100 + sin(angle - M_PI / 2) * 70;
    x2 = 100;// + cos(angle + M_PI / 2) * 20;
...
/*    x = 100 - cos(angle) * 30;
    ...
    blit(tbmp2, tbmp, 0,0,0,0,210,210);
    clear_bitmap(tbmp2);
    x = x1 + cos(angle + M_PI / 4 + M_PI / 6) * 40;
    y = y1 + sin(angle + M_PI / 4 + M_PI / 6) * 40;
    circlefill(tbmp, x, y, 20, COLOUR_GREY4);
    circlefill(tbmp, x, y, 10, COLOUR_GREY5);
    x = x1 + cos(angle - M_PI / 4 - M_PI / 6) * 40;
    y = y1 + sin(angle - M_PI / 4 - M_PI / 6) * 40;
...
/*    if (i == 12)
  ...
  case 15:
   for (i = 0; i < 17; i ++)
   {
    ...
    if (i == 16)
     angle = 0;
    x1 = 100 + cos(angle + M_PI / 26) * 90;
    y1 = 100 + sin(angle + M_PI / 26) * 90;
    x2 = 100 + cos(angle + M_PI / 2) * 60;
    y2 = 100 + sin(angle + M_PI / 2) * 60;
    x3 = 100 + cos(angle + M_PI - M_PI / 26) * 60;
    y3 = 100 + sin(angle + M_PI - M_PI / 26) * 60;
    triangle(tbmp, x1, y1, x2, y2, x3, y3, COLOUR_GREY4);
    x1 = 100 + cos(angle - M_PI / 26) * 90;
    y1 = 100 + sin(angle - M_PI / 26) * 90;
    x2 = 100 + cos(angle - M_PI / 2) * 60;
    ...
    y3 = 100 + sin(angle + M_PI + M_PI / 26) * 60;
    triangle(tbmp, x1, y1, x2, y2, x3, y3, COLOUR_GREY4);
/*    x1 = 100 + cos(angle + M_PI - M_PI / 4) * 50;
    y1 = 100 + sin(angle + M_PI - M_PI / 4) * 50;
    ...
    x1 = 100 + cos(angle + M_PI / 26) * 80;
    y1 = 100 + sin(angle + M_PI / 26) * 80;
    x2 = 100 + cos(angle + M_PI / 2) * 50;
    y2 = 100 + sin(angle + M_PI / 2) * 50;
    x3 = 100 + cos(angle + M_PI - M_PI / 26) * 50;
    y3 = 100 + sin(angle + M_PI - M_PI / 26) * 50;
    triangle(tbmp, x1, y1, x2, y2, x3, y3, COLOUR_GREY5);
    x1 = 100 + cos(angle - M_PI / 26) * 80;
    y1 = 100 + sin(angle - M_PI / 26) * 80;
    x2 = 100 + cos(angle - M_PI / 2) * 50;
